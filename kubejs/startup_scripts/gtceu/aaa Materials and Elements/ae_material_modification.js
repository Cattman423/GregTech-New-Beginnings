...
//Formulas
    ...
    GTMaterials.get('refined_radiance').setFormula('☈', true)
    GTMaterials.get('shadow_steel').setFormula('Sh', true)
    GTMaterials.get('shadow_radiance').setFormula('Sh☈', true)
    GTMaterials.Americium.setFormula('Am²⁴³', true)
    GTMaterials.Berkelium.setFormula('Bk²⁴⁷', true)
    GTMaterials.Caesium.setFormula('Cs¹³³', true)
    GTMaterials.Californium.setFormula('Cf²⁵¹', true)
    GTMaterials.Curium.setFormula('Cm²⁴⁷', true)
    GTMaterials.Europium.setFormula('Eu¹⁵¹', true)
    GTMaterials.Lithium.setFormula('Li⁷', true)
    GTMaterials.Neptunium.setFormula('Np²³⁷', true)
    GTMaterials.Promethium.setFormula('Pm¹⁴⁷', true)
    GTMaterials.Protactinium.setFormula('Pa²³³', true)
    GTMaterials.Ruthenium.setFormula('Ru¹⁰¹', true)
    GTMaterials.Strontium.setFormula('Sr⁸⁷', true)

//Iconsets
    GTMaterials.Neutronium.setMaterialIconSet(GTMaterialIconSet.RADIOACTIVE)
    GTMaterials.get('refined_radiance').setMaterialIconSet(GTMaterialIconSet.DULL)
    GTMaterials.get('shadow_steel').setMaterialIconSet(GTMaterialIconSet.DULL)
    GTMaterials.Americium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Berkelium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Californium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Curium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Europium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Neptunium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Plutonium239.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Plutonium241.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Promethium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Protactinium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Ruthenium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Strontium.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Uranium235.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
    GTMaterials.Uranium238.setMaterialIconSet(GTMaterialIconSet.getByName('radioisotope'))
})