...
//Volt Tiers
    let ULv = GTValues.V[GTValues.ULV]
    let Lv = GTValues.V[GTValues.LV]
    let Mv = GTValues.V[GTValues.MV]
    let Hv = GTValues.V[GTValues.HV]
    let Ev = GTValues.V[GTValues.EV]
    let Iv = GTValues.V[GTValues.IV]
    let LUv = GTValues.V[GTValues.LuV]
    let ZPm = GTValues.V[GTValues.ZPM]
    let Uv = GTValues.V[GTValues.UV]
    let UHv = GTValues.V[GTValues.UHV]
    let UEv = GTValues.V[GTValues.UEV]
    let UIv = GTValues.V[GTValues.UIV]
    let UXv = GTValues.V[GTValues.UXV]
    let OPv = GTValues.V[GTValues.OpV]
    let MAx = GTValues.V[GTValues.MAX]

    let AULv = GTValues.VA[GTValues.ULV]
    let ALv = GTValues.VA[GTValues.LV]
    let AMv = GTValues.VA[GTValues.MV]
    let AHv = GTValues.VA[GTValues.HV]
    let AEv = GTValues.VA[GTValues.EV]
    let AIv = GTValues.VA[GTValues.IV]
    let ALUv = GTValues.VA[GTValues.LuV]
    let AZPm = GTValues.VA[GTValues.ZPM]
    let AUv = GTValues.VA[GTValues.UV]
    let AUHv = GTValues.VA[GTValues.UHV]
    let AUEv = GTValues.VA[GTValues.UEV]
    let AUIv = GTValues.VA[GTValues.UIV]
